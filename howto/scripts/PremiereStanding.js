...
async function writeCSV(data) {
    ...
    const filePath = path.join(dirPath, 'premiere_JS2.csv');
...
// const milliseconds = Date.parse("November 19, 1986")
// console.log(`this is the number of milliseconds counted since the moment of my birth : ${milliseconds}`)
